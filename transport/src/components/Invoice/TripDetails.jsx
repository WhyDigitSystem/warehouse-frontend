...
export default function TripDetailsTab() {
    ...
    return (
        <div className="p-1 space-y-4" onClick={handleClickOutside}>
            {/* Header Section */}
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    {/* Fetch Trips Button */}
                    <button className="flex items-center gap-2 px-2 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm">
